...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_hero_banner_link_config_link_type" AS ENUM('internal', 'external');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_banner_link_config_link_type" AS ENUM('internal', 'external');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_categories_banner_link_config_link_type" AS ENUM('internal', 'external');
  CREATE TYPE "public"."enum_attributes_group" AS ENUM('story', 'fandom', 'year', 'bookcover', 'pages', 'images', 'isbn', 'genre');
  CREATE TYPE "public"."enum_wayforpay_payments_status" AS ENUM('created', 'pending', 'finalizing', 'approved', 'declined', 'expired', 'refunded', 'failed');
  CREATE TYPE "public"."enum_wayforpay_payments_currency" AS ENUM('UAH');
  ...
  CREATE TYPE "public"."enum_products_product_type" AS ENUM('simple', 'configurable', 'virtual');
  CREATE TYPE "public"."enum_products_stock_status" AS ENUM('in_stock', 'out_stock', 'presell');
  ...
  CREATE TYPE "public"."enum__products_v_version_product_type" AS ENUM('simple', 'configurable', 'virtual');
  CREATE TYPE "public"."enum__products_v_version_stock_status" AS ENUM('in_stock', 'out_stock', 'presell');
  ...
  CREATE TYPE "public"."enum_transactions_currency" AS ENUM('UAH');
  ...
  CREATE TABLE "pages" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"hero_banner_show_banner" boolean DEFAULT false,
  	"hero_banner_mobile_image_id" integer,
  	"hero_banner_desktop_image_id" integer,
  	"hero_banner_title" varchar,
  	"hero_banner_description" varchar,
  	"hero_banner_link_config_link_type" "enum_pages_hero_banner_link_config_link_type" DEFAULT 'internal',
  	"hero_banner_link_config_external_url" varchar,
  	"hero_banner_link_config_button_text" varchar DEFAULT 'Детальніше',
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_hero_banner_show_banner" boolean DEFAULT false,
  	"version_hero_banner_mobile_image_id" integer,
  	"version_hero_banner_desktop_image_id" integer,
  	"version_hero_banner_title" varchar,
  	"version_hero_banner_description" varchar,
  	"version_hero_banner_link_config_link_type" "enum__pages_v_version_hero_banner_link_config_link_type" DEFAULT 'internal',
  	"version_hero_banner_link_config_external_url" varchar,
  	"version_hero_banner_link_config_button_text" varchar DEFAULT 'Детальніше',
  ...
  CREATE TABLE "categories" (
  	...
  	"parent_id" integer,
  	"banner_show_banner" boolean DEFAULT false,
  	"banner_mobile_image_id" integer,
  	"banner_desktop_image_id" integer,
  	"banner_title" varchar,
  	"banner_description" varchar,
  	"banner_link_config_link_type" "enum_categories_banner_link_config_link_type" DEFAULT 'internal',
  	"banner_link_config_external_url" varchar,
  	"banner_link_config_button_text" varchar DEFAULT 'Детальніше',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "attributes" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"group" "enum_attributes_group" NOT NULL,
  	"value" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE "wayforpay_payments" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order_reference" varchar NOT NULL,
  	"public_token" varchar NOT NULL,
  	"status" "enum_wayforpay_payments_status" DEFAULT 'created' NOT NULL,
  	"amount_minor" numeric NOT NULL,
  	"provider_amount" varchar NOT NULL,
  	"currency" "enum_wayforpay_payments_currency" DEFAULT 'UAH' NOT NULL,
  	"cart_id" integer NOT NULL,
  	"customer_id" integer,
  	"customer_email" varchar NOT NULL,
  	"items_snapshot" jsonb NOT NULL,
  	"shipping_address_snapshot" jsonb NOT NULL,
  	"nova_poshta_delivery_snapshot" jsonb NOT NULL,
  	"order_id" integer,
  	...
  	"card_pan" varchar,
  	"card_type" varchar,
  	"processing_date" timestamp(3) with time zone,
  	"callback_received_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "products_blocks_image_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_products_v_blocks_image_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "carts" (
  	...
  	"subtotal" numeric,
  	"currency" "enum_carts_currency" DEFAULT 'UAH',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "orders" (
  	...
  	"shipping_address_father_name" varchar,
  	"customer_id" integer,
  	"customer_email" varchar,
  	"status" "enum_orders_status" DEFAULT 'processing',
  	"amount" numeric,
  	"currency" "enum_orders_currency" DEFAULT 'UAH',
  	"access_token" varchar,
  	"nova_poshta_shipping" jsonb,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "transactions" (
  	...
  	"billing_address_father_name" varchar,
  	...
  	"cart_id" integer,
  	"amount" numeric,
  	"currency" "enum_transactions_currency" DEFAULT 'UAH',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "pages" ADD CONSTRAINT "pages_hero_banner_mobile_image_id_media_id_fk" FOREIGN KEY ("hero_banner_mobile_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages" ADD CONSTRAINT "pages_hero_banner_desktop_image_id_media_id_fk" FOREIGN KEY ("hero_banner_desktop_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_version_hero_banner_mobile_image_id_media_id_fk" FOREIGN KEY ("version_hero_banner_mobile_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_version_hero_banner_desktop_image_id_media_id_fk" FOREIGN KEY ("version_hero_banner_desktop_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "categories" ADD CONSTRAINT "categories_banner_mobile_image_id_media_id_fk" FOREIGN KEY ("banner_mobile_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "categories" ADD CONSTRAINT "categories_banner_desktop_image_id_media_id_fk" FOREIGN KEY ("banner_desktop_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "wayforpay_payments" ADD CONSTRAINT "wayforpay_payments_cart_id_carts_id_fk" FOREIGN KEY ("cart_id") REFERENCES "public"."carts"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "wayforpay_payments" ADD CONSTRAINT "wayforpay_payments_customer_id_users_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "wayforpay_payments" ADD CONSTRAINT "wayforpay_payments_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "products_blocks_image_text" ADD CONSTRAINT "products_blocks_image_text_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_blocks_image_text" ADD CONSTRAINT "products_blocks_image_text_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "products_rels" ADD CONSTRAINT "products_rels_attributes_fk" FOREIGN KEY ("attributes_id") REFERENCES "public"."attributes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_blocks_image_text" ADD CONSTRAINT "_products_v_blocks_image_text_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_blocks_image_text" ADD CONSTRAINT "_products_v_blocks_image_text_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_rels" ADD CONSTRAINT "_products_v_rels_attributes_fk" FOREIGN KEY ("attributes_id") REFERENCES "public"."attributes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_wayforpay_payments_fk" FOREIGN KEY ("wayforpay_payments_id") REFERENCES "public"."wayforpay_payments"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_hero_banner_hero_banner_mobile_image_idx" ON "pages" USING btree ("hero_banner_mobile_image_id");
  CREATE INDEX "pages_hero_banner_hero_banner_desktop_image_idx" ON "pages" USING btree ("hero_banner_desktop_image_id");
  ...
  CREATE INDEX "_pages_v_version_hero_banner_version_hero_banner_mobile__idx" ON "_pages_v" USING btree ("version_hero_banner_mobile_image_id");
  CREATE INDEX "_pages_v_version_hero_banner_version_hero_banner_desktop_idx" ON "_pages_v" USING btree ("version_hero_banner_desktop_image_id");
  ...
  CREATE INDEX "categories_banner_banner_mobile_image_idx" ON "categories" USING btree ("banner_mobile_image_id");
  CREATE INDEX "categories_banner_banner_desktop_image_idx" ON "categories" USING btree ("banner_desktop_image_id");
  ...
  CREATE UNIQUE INDEX "wayforpay_payments_order_reference_idx" ON "wayforpay_payments" USING btree ("order_reference");
  CREATE UNIQUE INDEX "wayforpay_payments_public_token_idx" ON "wayforpay_payments" USING btree ("public_token");
  CREATE INDEX "wayforpay_payments_status_idx" ON "wayforpay_payments" USING btree ("status");
  CREATE INDEX "wayforpay_payments_cart_idx" ON "wayforpay_payments" USING btree ("cart_id");
  CREATE INDEX "wayforpay_payments_customer_idx" ON "wayforpay_payments" USING btree ("customer_id");
  CREATE UNIQUE INDEX "wayforpay_payments_order_idx" ON "wayforpay_payments" USING btree ("order_id");
  CREATE INDEX "wayforpay_payments_updated_at_idx" ON "wayforpay_payments" USING btree ("updated_at");
  CREATE INDEX "wayforpay_payments_created_at_idx" ON "wayforpay_payments" USING btree ("created_at");
  ...
  CREATE INDEX "products_blocks_image_text_order_idx" ON "products_blocks_image_text" USING btree ("_order");
  CREATE INDEX "products_blocks_image_text_parent_id_idx" ON "products_blocks_image_text" USING btree ("_parent_id");
  CREATE INDEX "products_blocks_image_text_path_idx" ON "products_blocks_image_text" USING btree ("_path");
  CREATE INDEX "products_blocks_image_text_image_idx" ON "products_blocks_image_text" USING btree ("image_id");
  ...
  CREATE INDEX "products_rels_attributes_id_idx" ON "products_rels" USING btree ("attributes_id");
  ...
  CREATE INDEX "_products_v_blocks_image_text_order_idx" ON "_products_v_blocks_image_text" USING btree ("_order");
  CREATE INDEX "_products_v_blocks_image_text_parent_id_idx" ON "_products_v_blocks_image_text" USING btree ("_parent_id");
  CREATE INDEX "_products_v_blocks_image_text_path_idx" ON "_products_v_blocks_image_text" USING btree ("_path");
  CREATE INDEX "_products_v_blocks_image_text_image_idx" ON "_products_v_blocks_image_text" USING btree ("image_id");
  ...
  CREATE INDEX "_products_v_rels_attributes_id_idx" ON "_products_v_rels" USING btree ("attributes_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_wayforpay_payments_id_idx" ON "payload_locked_documents_rels" USING btree ("wayforpay_payments_id");
...
export async function down(_args: MigrateDownArgs): Promise<void> {
  throw new Error(
    'Baseline rollback is unsupported. Destroy disposable local databases as whole containers or databases. Existing-database recovery requires restoration from a verified backup under a later approval gate.',
  )
  /* Historical generated destructive down SQL intentionally removed. It must never be executable.
  ...
  DROP TABLE "wayforpay_payments" CASCADE;
  ...
  DROP TABLE "products_blocks_image_text" CASCADE;
  ...
  DROP TABLE "_products_v_blocks_image_text" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_hero_banner_link_config_link_type";
  ...
  DROP TYPE "public"."enum__pages_v_version_hero_banner_link_config_link_type";
  DROP TYPE "public"."enum__pages_v_version_hero_type";
  DROP TYPE "public"."enum__pages_v_version_status";
  DROP TYPE "public"."enum_categories_banner_link_config_link_type";
  DROP TYPE "public"."enum_attributes_group";
  DROP TYPE "public"."enum_wayforpay_payments_status";
  DROP TYPE "public"."enum_wayforpay_payments_currency";
